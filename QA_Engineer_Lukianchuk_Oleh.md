I wrote the programs and unit tests in JavaScript using "Jest", and added CI “continuous integration” on GitHub. Added Linter test too. Test cases in the README.md files are also duplicated
